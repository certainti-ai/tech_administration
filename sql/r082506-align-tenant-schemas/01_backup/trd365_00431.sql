...
CREATE TABLE "trd365_00431"."r082506_case_technical_summary" AS SELECT * FROM "trd365_00431"."case_technical_summary";
COMMENT ON TABLE "trd365_00431"."r082506_case_technical_summary" IS 'r082506 pre-alignment copy of case_technical_summary, taken 2026-08-25';
...
BEGIN
  FOREACH t IN ARRAY ARRAY['case_technical_summary'] LOOP
    EXECUTE format('SELECT count(*) FROM %I.%I', 'trd365_00431', t) INTO a;
    EXECUTE format('SELECT count(*) FROM %I.%I', 'trd365_00431', 'r082506_' || t) INTO b;
