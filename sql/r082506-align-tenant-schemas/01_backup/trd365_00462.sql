...
-- interactions
CREATE TABLE "trd365_00462"."r082506_interactions" AS SELECT * FROM "trd365_00462"."interactions";
COMMENT ON TABLE "trd365_00462"."r082506_interactions" IS 'r082506 pre-alignment copy of interactions, taken 2026-08-25';

-- Row counts must match before anything is altered.
DO $$
DECLARE t text; a bigint; b bigint;
BEGIN
  FOREACH t IN ARRAY ARRAY['interactions'] LOOP
    EXECUTE format('SELECT count(*) FROM %I.%I', 'trd365_00462', t) INTO a;
    EXECUTE format('SELECT count(*) FROM %I.%I', 'trd365_00462', 'r082506_' || t) INTO b;
