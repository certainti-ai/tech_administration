-- Align to baseline — trd365_00431
...
-- Run 01_backup/trd365_00431.sql first.
...
-- ---- default (1) ------------------------------------------------
ALTER TABLE "trd365_00431"."case_technical_summary" ALTER COLUMN "created_datetime" SET DEFAULT now();
