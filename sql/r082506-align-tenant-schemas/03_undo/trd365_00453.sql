...
-- trd365_00453.r082506_<table>.  Restoring it is a deliberate act:
--   BEGIN;
--   DELETE FROM "trd365_00453"."<table>";
--   INSERT INTO "trd365_00453"."<table>" SELECT * FROM "trd365_00453"."r082506_<table>";
--   COMMIT;
