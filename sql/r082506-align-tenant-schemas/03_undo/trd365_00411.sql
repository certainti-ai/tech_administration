-- Undo — trd365_00411
-- Generated 2026-08-25 from the live definition of trd365_00411.
...
BEGIN;
SET LOCAL search_path = "trd365_00411";

-- nothing was altered in this schema

COMMIT;

-- If a type conversion mangled values, the pre-change data is in
-- trd365_00411.r082506_<table>.  Restoring it is a deliberate act:
--   BEGIN;
--   DELETE FROM "trd365_00411"."<table>";
--   INSERT INTO "trd365_00411"."<table>" SELECT * FROM "trd365_00411"."r082506_<table>";
--   COMMIT;
