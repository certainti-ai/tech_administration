...
ALTER TABLE "trd365_00462"."interactions" DROP COLUMN IF EXISTS "section_percentages";

COMMIT;

-- If a type conversion mangled values, the pre-change data is in
-- trd365_00462.r082506_<table>.  Restoring it is a deliberate act:
--   BEGIN;
--   DELETE FROM "trd365_00462"."<table>";
--   INSERT INTO "trd365_00462"."<table>" SELECT * FROM "trd365_00462"."r082506_<table>";
--   COMMIT;
