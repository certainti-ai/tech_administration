...
ALTER TABLE "trd365_00436"."case_technical_summary" ALTER COLUMN "created_datetime" DROP DEFAULT;

COMMIT;

-- If a type conversion mangled values, the pre-change data is in
-- trd365_00436.r082506_<table>.  Restoring it is a deliberate act:
--   BEGIN;
--   DELETE FROM "trd365_00436"."<table>";
--   INSERT INTO "trd365_00436"."<table>" SELECT * FROM "trd365_00436"."r082506_<table>";
--   COMMIT;
