-- Undo — trd365_00428
-- Generated 2026-08-25 from the live definition of trd365_00428.
...
BEGIN;
SET LOCAL search_path = "trd365_00428";
...
-- trd365_00428.r082506_<table>.  Restoring it is a deliberate act:
--   BEGIN;
--   DELETE FROM "trd365_00428"."<table>";
--   INSERT INTO "trd365_00428"."<table>" SELECT * FROM "trd365_00428"."r082506_<table>";
--   COMMIT;
