...
<li><span class="sb">Timesheet hours were submitted for this project</span> — 74,133.8 across 40 employees, 94% of what existed. P1 is the one project whose hours CRA actually received. <span class="sb">Not submitted:</span> hourly wages, and any SR&amp;ED versus non-SR&amp;ED split.</li>
</ul></div></div>''',
...
<li><span class="sb">Hours: 21,702 submitted against 90,832 that existed — 24%.</span> Those hours reached CRA only incidentally, because eleven people on the P1/P2 employee list also charged time here. The extract was never scoped to this project code.</li>
